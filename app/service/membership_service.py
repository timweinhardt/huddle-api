...
from app.model.membership_model import LocationMembership, Membership, Role, UserMembership
from app.utils.time import get_current_time
from boto3.dynamodb.conditions import Key

class MembershipService:
    def __init__(self):
        self.db = Table(table_name=config.memberships_table_name, aws_region=config.aws_region)
    ...
    def get_location_memberships(
        ...
        items = self.db.query_gsi(
            index_name="location_membership_index",
